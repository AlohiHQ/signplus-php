...
class AddEnvelopeAnnotationRequestDatetime implements \JsonSerializable
{
  #[SerializedName('size')]
  public ?float $size;

  #[SerializedName('font')]
  public ?DatetimeFont1 $font;
  ...
  public static function fromArray(array $data): self
  {
    return new self(
      ...
      font: isset($data['font']) && is_array($data['font'])
        ? DatetimeFont1::fromArray($data['font'])
        : null,
