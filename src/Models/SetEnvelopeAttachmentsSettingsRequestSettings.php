...
class SetEnvelopeAttachmentsSettingsRequestSettings implements \JsonSerializable
{
  #[SerializedName('visible_to_recipients')]
  public ?string $visibleToRecipients;

  public function __construct(?string $visibleToRecipients = null)
  {
